  ...
  const screenshots = [
    {
      ...
      description:
        "AI-powered diagnosis with confidence scores and remediation options",
    },
    {
    ...
    },
    {
      ...
      description:
        "Automated detection of 21+ issue types - health, security, performance",
    },
    {
      ...
      description:
        "Multiple fix recommendations with confidence levels and evidence",
    },
    {
      ...
      description:
        "Integrate Prometheus, ArgoCD, Helm, GitHub, Trivy with one click",
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-400 mb-8">
              Explore KubePilot's powerful features with real app screenshots
            </p>
            <button
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            ...
            >
              <span className="text-sky-400/60 font-semibold text-sm">
            ...
            <div className="flex items-center justify-between gap-4">
              ...
              <div className="text-center">
                ...
                <p className="text-gray-500 text-xs mt-3">
                  Press{" "}
                  <kbd className="bg-blue-900/40 px-2 py-1 rounded text-sky-400/60">
                    ESC
                  </kbd>{" "}
                  to close •{" "}
                  <kbd className="bg-blue-900/40 px-2 py-1 rounded text-sky-400/60">
