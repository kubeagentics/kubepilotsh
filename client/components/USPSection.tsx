import { Zap, Shield, Brain, Settings, Clock, Gauge, Unlock, Code } from "lucide-react";
  ...
  const usps = [
    {
      ...
      description: "Built-in AI understands Kubernetes. Ask natural questions, get actionable answers. No more Stack Overflow hunting.",
      image:
    ...
    },
    {
      ...
      description: "Works with OpenAI, Anthropic Claude, Google Gemini, Ollama (local), or any OpenAI-compatible endpoint. Zero vendor lock-in.",
      image:
    ...
    },
    {
      ...
      description: "Automated cluster health checks, security scanning, performance analysis, and configuration drift detection. 21 issue types detected.",
      image:
    ...
    },
    {
      ...
      description: "AI-powered root cause analysis with confidence scores, evidence trails, and multiple remediation options in one click.",
      image:
    ...
    },
    {
      ...
      description: "Built-in MCP (Model Context Protocol) server library. Add Prometheus, ArgoCD, Helm, GitHub, Trivy with one click.",
      image:
    ...
    },
    {
      ...
      description: "Real-time cluster overview with CPU, memory, pod status, and node health. Live Watch API updates. No browser tabs needed.",
      image:
    ...
    <section className="bg-zinc-900 text-white py-20">
      <div className="max-w-7xl mx-auto px-6">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-bold mb-4">Everything you need to master Kubernetes</h2>
          <p className="text-xl text-gray-400">No subscriptions. No feature gates. Just powerful K8s tooling.</p>
        </div>
